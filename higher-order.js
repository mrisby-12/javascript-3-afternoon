...
//Code Here
let evenNumbers = mixedNumbers.filter((evens) => evens % 2 === 0);
...
let ordersTotal = orders.map( (element) => element.price * (element.tax + 1) );
...
let bobsTotal = purchases.filter( (purchase) => purchase.owner === 'Bob').reduce( (a, b) => { return a + b.price}, 0);
